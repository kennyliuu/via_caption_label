...
# 定義來源資料夾和目標資料夾
source_folder = r'D:\dataset\current\writing a test paper'
target_folder = r'D:\dataset\current_aug\writing a test paper'
...
print("所有圖片及其對應的 XML 檔案已成功縮小並保存到目標資料夾 所有圖片從編號 {start_index} 開始")
